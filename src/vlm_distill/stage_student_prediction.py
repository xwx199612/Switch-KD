...
class MockStudent:
    def answer(self, sample: VlmSample) -> dict:
        ...
        return {
            ...
            "student_tokens": [ord(char) for char in student_answer],
...
class HuggingFaceStudent:
    ...
    def answer(self, sample: VlmSample) -> dict:
        ...
        return {
            ...
            "student_tokens": self.tokenize_student_answer(answer.strip()),
...
def _predict_sample(student: StudentBackend, sample: VlmSample) -> dict:
    ...
    answer = _normalize_teacher_answer(sample, prediction["student_answer"])
    tokens = prediction.get("student_tokens")
    if not isinstance(tokens, list):
        tokenizer = getattr(student, "tokenize_student_answer", None)
    ...
    return {
        ...
        "student_tokens": [int(token_id) for token_id in tokens],
    }
